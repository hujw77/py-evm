...
class PluginManager:
    ...
    def _is_responsible_for_plugin(self, plugin: BasePlugin) -> bool:
        ...
        manager_for_main_or_isolated = isinstance(self._scope, MainAndOwnProcessScope)
    ...
    def _create_context_for_plugin(self, plugin: BasePlugin) -> PluginContext:
