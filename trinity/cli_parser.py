...
parser.add_argument(
    '--light', action='store_true'  # TODO: consider --sync-mode like geth.
)
parser.add_argument(
    '--trinity-root-dir',
    help=(
...
parser.add_argument('--data-dir', help=("The directory where chain data is stored"))
parser.add_argument(
    '--nodekey', help=("Hexadecimal encoded private key to use for the nodekey")
)
parser.add_argument(
    '--nodekey-path',
    help=("The filesystem path to the file which contains the nodekey"),
)
