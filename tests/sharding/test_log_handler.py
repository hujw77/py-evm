...
from evm.vm.forks.sharding.log_handler import (
    LogHandler, check_chain_head, get_recent_block_hashes, preprocess_block_param
)
...
abi = [
    {
        'name': 'Test',
        'inputs': [{'type': 'int128', 'name': 'amount1', 'indexed': False}],
        'anonymous': False,
        'type': 'event',
    },
    {
        'name': 'emit_log',
        'outputs': [],
        'inputs': [{'type': 'int128', 'name': 'log_number'}],
        'constant': False,
        'payable': False,
        'type': 'function',
    },
