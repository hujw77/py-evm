...
def pytest_generate_tests(metafunc):
    generate_fixture_tests(metafunc=metafunc, base_fixture_path=BASE_FIXTURE_PATH)


@pytest.fixture
def fixture(fixture_data):
    fixture_path, fixture_key = fixture_data
    fixture = load_fixture(fixture_path, fixture_key, normalize_transactiontest_fixture)
    return fixture
...
def test_transaction_fixtures(fixture):
    ...
    if 'sender' in fixture:
        ...
        # rlp is invalid or not in the correct form
            ...
            rlp.exceptions.ObjectDeserializationError, rlp.exceptions.DecodingError
        ):
            return
