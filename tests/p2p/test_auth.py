...
async def test_handshake():
    ...
    initiator = HandshakeInitiator(
        initiator_remote, keys.PrivateKey(test_values['initiator_private_key'])
    )
    ...
    responder_writer = type(
        "mock-streamwriter", (object,), {"write": initiator_reader.feed_data}
    )
    initiator_writer = type(
        "mock-streamwriter", (object,), {"write": responder_reader.feed_data}
    )
