...
from evm.exceptions import (TransactionNotFound,)
from evm.vm.forks.frontier.blocks import FrontierBlock

from tests.core.fixtures import (valid_block_rlp, chaindb)  # noqa: F401
...
def test_import_block_validation(
    ...
    assert state_db.get_balance(
        decode_hex("095e7baea6a6c7c4c2dfeb977efac326af552d87")
    ) == tx.value
...
@pytest.mark.parametrize(
    ...
    ((b'', None, None, True, 21000), (b'', None, None, False, 21000), (b'\xff' * 10, None, None, True, 21680), (b'\xff' * 10, None, None, False, 21680), (b'\xff' * 32, None, ADDRESS_2, True, 35381), (b'\xff' * 32, None, ADDRESS_2, False, 35369), (b'\xff' * 320, None, ADDRESS_2, True, 54888), (b'\xff' * 32, binary_gas_search_1000_tolerance, ADDRESS_2, True, 23938)),
    # sha3 precompile
...
def test_estimate_gas(
    ...
    from_ = funded_address
    tx = new_transaction(
        vm, from_, recipient, amount, funded_address_private_key, data=data
    )
    if on_pending:
