...
def test_sub_name_configuration():
    result = Outer.configure(
        ** {'attr_e.__name__': 'ConfiguredInner', 'attr_e.attr_a': 'configured-a'}
    )
...
@pytest.mark.parametrize('key', ('top_level', 'top_level.nested_level'))
