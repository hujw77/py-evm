...
from evm.utils.env import (env_int,)


@pytest.mark.parametrize('env_value,expected', (('1', 1), ('123', 123), ('-123', -123)))
...
@pytest.mark.parametrize('default,expected', ((1, 1), ('1', 1), ('-1', -1), (-1, -1)))
