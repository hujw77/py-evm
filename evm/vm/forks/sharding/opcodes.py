import copy
from cytoolz import (merge, dissoc)

from evm import constants
from evm.vm.forks.tangerine_whistle.constants import (GAS_CALL_EIP150,)
from evm import opcode_values
from evm import mnemonics

from evm.opcode import as_opcode
from evm.logic import (call, context, system)
...
REMOVED_OPCODES = [opcode_values.CREATE, opcode_values.SELFDESTRUCT]
REPLACED_OPCODES = {
