...
def get_sharding_config():
    return {
        ...
        'DEPOSIT_SIZE': env.get('PYEVM_SHARDING_DEPOSIT_SIZE', type=int, default=to_wei('100', 'ether')),
        ...
        'COLLATION_GASLIMIT': env.get('PYEVM_SHARDING_COLLATION_GASLIMIT', type=int, default=10 ** 7),
        ...
        'COLLATOR_REWARD': env.get('PYEVM_SHARDING_COLLATOR_REWARD', type=int, default=to_wei('0.001', 'ether')),
        # default gas_price
