from eth_utils import (
    combine_argument_formatters, encode_hex, to_checksum_address, to_hex
)
import cytoolz.curried
import eth_utils.curried

environment_formatter = eth_utils.curried.apply_formatters_to_dict(
    {"currentCoinbase": to_checksum_address, "previousHash": encode_hex, "currentNumber": to_hex, "currentDifficulty": to_hex, "currentGasLimit": to_hex, "currentTimestamp": to_hex, "shardID": to_hex, "expectedPeriodNumber": to_hex, "periodStartHash": encode_hex, "currentCoinbase": to_checksum_address, "currentNumber": to_hex}
    # shared
...
transaction_group_formatter = eth_utils.curried.apply_formatters_to_dict(
    {"to": to_checksum_address, "data": eth_utils.curried.apply_formatter_to_array(encode_hex), "gasLimit": eth_utils.curried.apply_formatter_to_array(to_hex), "gasPrice": to_hex, "nonce": to_hex, "secretKey": encode_hex, "value": eth_utils.curried.apply_formatter_to_array(to_hex), "chainID": to_hex, "shardID": to_hex, "code": encode_hex, "accessList": access_list_formatter}
